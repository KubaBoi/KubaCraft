...
execute as @s if entity @s[tag=ar0] if entity @e[tag=ar0,scores={random=50..80}] run summon minecraft:pig ~ ~ ~ {Tags:["ar0_m"],}
execute as @s if entity @s[tag=ar0] if entity @e[tag=ar0,scores={random=80..100}] run summon minecraft:bat ~ ~ ~ {Tags:["ar0_m"],}
